const pokemon = Object.freeze([
    ...
    { "id": 122, "name": "Mr. Mime",   "types": ["psychic","normal"] },
...
const div3Pkm = pokemon.filter(p => p.id % 3 === 0 );
console.log(div3Pkm); 
...
const namePkm = pokemon.map(p => p.name);
console.log(namePkm)

//Una matriz con solo los nombres de Pokémon con una identificación mayor que 99
const nameId99 = pokemon.filter(p => p.id > 99).map(p => p.name);
